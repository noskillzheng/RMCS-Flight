...
private:
    void gimbal_calibrate_subscription_callback(std_msgs::msg::Int32::UniquePtr) {
        ...
        RCLCPP_INFO(
            ...
            static_cast<long>(top_board_->gimbal_bullet_feeder_.calibrate_zero_point()));
        RCLCPP_INFO(
    ...
    public:
        explicit SteeringInfantryCommand(SteeringInfantry& infantry)
            : infantry_(infantry) {}
    ...
    public:
        ...
        explicit TopBoard(
            ...
            , logger_(steering_infantry.get_logger())
            ...
            , gimbal_bullet_feeder_(steering_infantry, steering_infantry_command, "/gimbal/bullet_feeder")
            {
            ...
            gimbal_bullet_feeder_.configure(
                device::DjiMotor::Config{device::DjiMotor::Type::kM3508}
                    .set_encoder_zero_point(
                        static_cast<int>(
                            steering_infantry.get_parameter("bullet_feeder_motor_zero_point").as_int()))
                    .set_reversed()
                    .enable_multi_turn_angle());

            steering_infantry.register_output("/gimbal/yaw/velocity_imu", gimbal_yaw_velocity_imu_);
            steering_infantry.register_output("/gimbal/pitch/velocity_imu", gimbal_pitch_velocity_imu_);
        ...
        void command_update() {
            ...
            builder.can2_transmit({
                ...
                .can_data = gimbal_yaw_motor_
                                .generate_velocity_command(gimbal_yaw_motor_.control_velocity() - imu_.gz())
                                .as_bytes(),
            });
    ...
    public:
        ...
        explicit BottomBoard_one(
            ...
            , chassis_front_climber_motor_(
                  {steering_infantry, steering_infantry_command, "/chassis/climber/left_front_motor"},
                  {steering_infantry, steering_infantry_command, "/chassis/climber/right_front_motor"})
            , chassis_back_climber_motor_(
                  {steering_infantry, steering_infantry_command, "/chassis/climber/left_back_motor"},
                  {steering_infantry, steering_infantry_command, "/chassis/climber/right_back_motor"})
            ...
            steering_infantry.register_output("/chassis/pitch_imu", chassis_pitch_imu_, 0.0);
        }
